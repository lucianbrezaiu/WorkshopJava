...
public class VehicleBusiness implements IVehicleBusiness
{
    ...
    @Override
    public void viewRentedVehicles(List<Contract> rents, String identificationNumber)
    {
        boolean ok = false;

        for(Contract rent : rents)
        {
            if(rent.getIdentificationNumber().equals(identificationNumber))
            {
                System.out.println(rent.getRegistrationNumber());
                ok = true;
            }
        }
